...
HWND CreateDlg(HWND hwnd,WORD *ptrdlg)
{
	...
	HWND hdlg=CreateDialogIndirect(hInstance,(LPDLGTEMPLATE)ptrdlg,hwnd,(DLGPROC)DlgProc);
...
LRESULT CALLBACK WndProc(HWND hwnd,UINT msg,WPARAM wParam,LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		ptr=(PWORD)LocalAlloc(LPTR,2000);
		hdlg=CreateDlg(hwnd,ptr);
		return 0;
	}
	case WM_LBUTTONDOWN:
